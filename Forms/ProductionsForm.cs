...
namespace JewelryStore.Forms
{
    ...
    public partial class ProductionsForm : Form
    {
        ...
        public void RefreshGrid()
        {
            ...
            //TODO получение всей продукции с включение материалов
            foreach (var m in context.Productions.Include(x=>x.MaterialCosts.Select(u=>u.Material)).ToList())
            {
        ...
        /// <summary>
        /// Вызов формы для добавления изделия
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
